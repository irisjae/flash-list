...
var FlashList = /** @class */ (function (_super) {
    ...
    function FlashList(props) {
        ...
        _this.container = function (props, children) {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(AutoLayoutView_1.default, tslib_1.__assign({}, props, { onBlankAreaEvent: _this.props.onBlankArea, onLayout: _this.updateDistanceFromWindow, disableAutoLayout: _this.props.disableAutoLayout, experimentalScrollPositionManagement: _this.props.experimentalScrollPositionManagement }), children),
                _this.isEmptyList
    ...
    FlashList.prototype.validateProps = function () {
        ...
        if (this.props.horizontal &&
            ...
            throw new CustomError_1.default(ExceptionList_1.default.horizontalMaintainScrollNotSupported);
        }
        if (this.props.experimentalScrollPositionManagement &&
            this.props.renderScrollComponent) {
            throw new CustomError_1.default(ExceptionList_1.default.customMaintainScrollNotSupported);
        }
    ...
    FlashList.prototype.render = function () {
        ...
        return (react_1.default.createElement(StickyHeaderContainer, { overrideRowRenderer: this.stickyOverrideRowRenderer, applyWindowCorrection: this.applyWindowCorrection, stickyHeaderIndices: stickyHeaderIndices, style: this.props.horizontal
            ...
            react_1.default.createElement(recyclerlistview_1.ProgressiveListView, tslib_1.__assign({}, restProps, { ref: this.recyclerRef, layoutProvider: this.state.layoutProvider, dataProvider: this.state.dataProvider, rowRenderer: this.emptyRowRenderer, canChangeSize: true, isHorizontal: Boolean(horizontal), scrollViewProps: tslib_1.__assign({ onScrollBeginDrag: this.onScrollBeginDrag, onLayout: this.handleSizeChange, refreshControl: this.props.refreshControl || this.getRefreshControl(), 
                    ...
                    : undefined, windowCorrectionConfig: this.getUpdatedWindowCorrectionConfig(), itemAnimator: this.itemAnimator, suppressBoundedSizeException: true, externalScrollView: (0, PlatformHelper_1.getBidirectionalScrollView)(Boolean(this.props.maintainVisibleContentPosition), renderScrollComponent) }))));
    };
    ...
    FlashList.prototype.experimentalFindApproxFirstVisibleIndex = function () {
        var _a, _b;
        return (_b = (_a = this.rlvRef) === null || _a === void 0 ? void 0 : _a.findApproxFirstVisibleIndex()) !== null && _b !== void 0 ? _b : 0;
    };
