    ...
    FlashList.prototype.scrollToIndex = function (params) {
        ...
        if (layout && listSize) {
            var getScrollCoords = function () {
                var _a, _b;
                var itemOffset = _this.props.horizontal ? layout.x : layout.y;
                var fixedDimension = _this.props.horizontal
                    ? listSize.width
                    : listSize.height;
                var itemSize = _this.props.horizontal ? layout.width : layout.height;
                var scrollOffset = Math.max(0, itemOffset - ((_a = params.viewPosition) !== null && _a !== void 0 ? _a : 0) * (fixedDimension - itemSize)) - ((_b = params.viewOffset) !== null && _b !== void 0 ? _b : 0);
                return { x: scrollOffset, y: scrollOffset };
            };
            var _e = getScrollCoords(), x = _e.x, y = _e.y;
            (_c = this.rlvRef) === null || _c === void 0 ? void 0 : _c.scrollToOffset(x, y, Boolean(params.animated), true, 
            ...
            params.index + (((_d = params.viewPosition) !== null && _d !== void 0 ? _d : 0 >= 0.5) ? 1 : 0), getScrollCoords);
        }
    };
